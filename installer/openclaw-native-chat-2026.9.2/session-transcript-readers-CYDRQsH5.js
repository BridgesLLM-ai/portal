import { M as resolveNonNegativeIntegerOption, d as asPositiveSafeInteger, j as resolveIntegerOption, l as asNonNegativeFiniteNumber, s as asFiniteNumber, u as asPositiveFiniteNumber } from "./number-coercion-CLj0HTDM.js";
import "./src-vebZIeLe.js";
import { i as estimateTokensFromChars, n as estimateStringChars } from "./cjk-chars-CGxY6W63.js";
...
import { i as executeSqliteQueryTakeFirstSync, r as executeSqliteQuerySync, s as prepareSqliteQuerySync } from "./kysely-sync-COmh4HWh.js";
import { t as readFileWindowFully } from "./file-read-DtMn74uz.js";
import { at as stripUserEnvelopeForDisplay, it as stripInternalMetadataForDisplay, ot as stripEnvelope } from "./openclaw-state-db-BRTnL-D8.js";
import "./internal-runtime-context-UgZVJlox.js";
import { n as extractInboundSenderLabel } from "./strip-inbound-meta-D5F_RINt.js";
import { g as materializeSessionArchiveForRead } from "./artifacts-DMDO9PHy.js";
import { r as jsonUtf8Bytes } from "./json-utf8-bytes-fm9i4b7G.js";
import { a as hasNonzeroUsage, c as normalizeUsage, r as deriveSessionTotalTokens } from "./usage-CtmV8Xxq.js";
import { n as estimateBase64DecodedBytes } from "./base64-Vw7DZYSc.js";
import { a as formatProviderRefusalText } from "./assistant-error-format-oP4GVe5A.js";
import { a as isContextOverflowError } from "./classify-GlkuT1ur.js";
import { c as isCompletionReportInputProvenance, d as normalizeInputProvenance, n as INTER_SESSION_PROMPT_PREFIX_BASE, p as stripInterSessionPromptPrefixForDisplay } from "./input-provenance-DiG-Cwnd.js";
import { t as readTranscriptSenderIdentity } from "./sender-identity-DQsesNZZ.js";
import { $ as readTranscriptRawDelta, A as withCurrentProjectionSnapshot, C as iterateVisibleMessageRange, D as resolveVisibleMessagePositions, L as resolveConcreteSessionStorePath, M as isSessionTranscriptProjectionUnavailableError, O as getActiveTranscriptKysely, Q as createTranscriptRawDeltaCursor, S as hasUnindexedVisibleMessages, T as readVisibleMessageRange, c as readRecentSessionTranscriptMessageEvents, h as visitSessionTranscriptMessageEvents, j as SessionTranscriptProjectionUnavailableError, k as readTranscriptProjectionGeneration, p as readSessionTranscriptMessageEvents, w as readVisibleMessageMetadata, x as assertVisibleMessageRangeJson, y as MAX_VISIBLE_MESSAGE_MAX_MESSAGES, z as resolveSessionTranscriptReadTarget } from "./session-accessor-YsytfDtG.js";
import { I as nestedToolActivityContent, R as readNestedToolActivity } from "./session-accessor.sqlite-transcript-store-B0zw3fAU.js";
import { t as STREAM_ERROR_FALLBACK_TEXT } from "./stream-message-shared-Cyrn1UHN.js";
import { l as selectSessionTranscriptActiveEntries } from "./transcript-tree-BH69pMSi.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase, t as extractAssistantPhaseText } from "./chat-message-content-Dws_XUEQ.js";
import { a as isOpenClawDeliveryMirrorAssistantMessage } from "./transcript-only-openclaw-assistant-CVgy4bjA.js";
import { r as resolveSqliteSessionTranscriptReadFence } from "./session-transcript-read-fence-CeDmfWcC.js";
import { a as waitForSessionTranscriptProjection } from "./session-transcript-reconcile-D3LiCrAp.js";
import { p as getUserProfileDisplay } from "./user-profiles-4AB7AmiH.js";
import { t as SessionManager } from "./session-manager-DO0bDxav.js";
import { a as parseInboundMediaUri, n as buildInboundMediaUriFromPath } from "./media-reference-ZG0ZXjCX.js";
import { n as projectAssistantDisplayContent, r as readAssistantDisplayContent } from "./assistant-display-content-BZljc_tT.js";
import { t as streamSessionTranscriptLines } from "./transcript-stream-DIGsiEca.js";
import { n as HEARTBEAT_PROMPT } from "./heartbeat-ofet59jF.js";
import "./fences-DtD_oijY.js";
import { n as isHeartbeatOkResponse, r as isHeartbeatUserMessage } from "./heartbeat-filter-64LAFCDI.js";
import { t as flattenMarkdownToPlainText } from "./markdown-plain-text-BIBtRgN0.js";
import { n as isSuppressedControlReplyText, r as stripSuppressedControlReplyToken } from "./control-reply-text-D2BZ73-q.js";
import { a as resolveSessionTranscriptCandidates, o as resolveSessionTranscriptResetArchiveCandidatesAsync } from "./session-transcript-files.fs-D0B5TSty.js";
import { a as hasAssistantDisplayableNonTextContent, c as isAssistantTextContentType, d as isSessionsSendInterSessionUserMessage, g as truncateChatHistoryText, h as takeAssistantManagedMediaUrlsForDisplay, i as extractProjectedText, l as isEmptyTextOnlyContent, m as stripAssistantMediaDirectivesForDisplay, n as asRoleContentMessage, o as hasAssistantNonTextContent, p as shouldPreserveAssistantControlReplyText, r as extractAssistantTextForSilentCheck, s as hasTranscriptMediaFacts, t as DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS, u as isProjectedSessionsSendForwardedMessage } from "./chat-display-projection.helpers-DYkWC7LH.js";
import { a as projectWorkspaceResultConflict } from "./workspace-conflicts-CQVfTI04.js";
import { c as buildControlUiUserAvatarPath } from "./control-ui-contract-zYW4RcpK.js";
...
function appendCanvasBlocksToAssistantHistoryMessage(message, previews) {
	if (!message || typeof message !== "object") return message;
	const entry = message;
...
function getAssistantErrorFallbackText(message) {
	return formatProviderRefusalText(message) ?? (isContextOverflowAssistantError(message) ? GATEWAY_ASSISTANT_CONTEXT_OVERFLOW_FALLBACK_TEXT : GATEWAY_ASSISTANT_ERROR_FALLBACK_TEXT);
}
...
function projectChatDisplayMessagesWithState(messages, options) {
	if (messages.length > 0 && messages.every(isInertHiddenAssistantText)) return {
		messages: [],
		turnBoundaryPending: options?.turnBoundaryPending === void 0 ? false : options.turnBoundaryPending,
		streamErrorFallbackPending: options?.streamErrorFallbackPending === void 0 ? false : options.streamErrorFallbackPending,
	...
	const repairedStreamErrors = projectRepairedStreamErrorFallbackMessages(toProjectedMessages(mirrorMessageToolVisibleReplies(options?.stripEnvelope === false ? projectedActivity : stripEnvelopeFromMessages(projectedActivity))), options?.streamErrorFallbackPending);
...
//#endregion
export { augmentChatHistoryWithCanvasBlocks as A, createCurrentUserProfileMessageProjector as C, sanitizeChatHistoryMessages as D, projectChatDisplayMessagesWithState as E, stripEnvelopeFromMessage as M, dropPreSessionStartAnnouncePairs as O, resolveCurrentUserProfileDisplay as S, projectChatDisplayMessages as T, ArchivedTranscriptReader as _, readSessionMessageCountAsync as a, projectSessionMessagePayload as b, readSessionMessagesPageWithStatsAsync as c, resolveTranscriptReadTarget as d, sqliteMessageEventWithSeq as f, readTranscriptDisplayDelta as g, readSessionTranscriptHistoryAnchorPage as h, readSessionMessageByIdAsync as i, projectSessionDisplayMessage as j, isHeartbeatHistoryTurnBoundaryMessage as k, readSessionMessagesWithSourceAsync as l, visitSessionMessagesAsync as m, readRecentSessionMessagesWithStatsAsync as n, readSessionMessagesAsync as o, toTranscriptReadScope as p, readRecentSessionUsageFromTranscript as r, readSessionMessagesMatchingIdAsync as s, readLatestSessionUsageFromTranscriptAsync as t, readSessionPreviewItemsFromTranscript as u, capArrayByJsonBytes as v, projectChatDisplayMessage as w, projectTranscriptEntryMessage as x, attachOpenClawTranscriptMeta as y };
