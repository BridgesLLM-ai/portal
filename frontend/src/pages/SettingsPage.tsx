...
import {
  Settings, Database, User, ShieldCheck, Palette, Mail, Bot, Server,
...
type TabId = 'general' | 'email' | 'security' | 'agents' | 'system' | 'ollama' | 'readiness' | 'backups' | 'profile';
...
const allTabs: TabDef[] = [
  ...
  { id: 'ollama', label: 'Ollama', icon: Bot, adminOnly: true },
          ...
          {settingsLoading && isAdmin && activeTab !== 'profile' && activeTab !== 'backups' ? (
            ...
            <>
              ...
              {activeTab === 'ollama' && (
                <OllamaTab
                  settings={settings}
                  updateSetting={(k, v) => updateSetting(k, v, 'ollama')}
                  onSave={() => saveSettings([
