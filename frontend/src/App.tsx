    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="terminal" element={<AdminRoute><Suspense fallback={<RouteFallback />}><TerminalPage /></Suspense></AdminRoute>} />
          ...
          <Route path="agent-tools" element={<Navigate to="/agent-chats" replace />} />
        </Route>
        <Route
          path="/setup"
